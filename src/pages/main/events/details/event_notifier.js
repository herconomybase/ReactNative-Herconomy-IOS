...
function EventNotifier({navigation, route}) {
  const {eventDetails, unit_count, payload} = route.params;
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.icon__section}>
        ...
        <View style={styles.iconContainer}>
          <Image source={require('../../../../../assets/img/calendar.png')} style={{width: '50%', height: '50%', resizeMode: 'contain'}} />
        </View>
      </View>
